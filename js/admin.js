...
async function bootstrap() {
    ...
    // Track form changes after data loads
    setTimeout(() => trackFormChanges(), 100);
}
                ...
                <td>
                    ${isOwnerRow ? '<span style="color:var(--text-dim);font-size:0.85rem;">Cannot modify owner</span>' : `
                        <div class="action-btns">
                            ...
                            <button class="icon-btn" data-user-action="toggle-publisher" data-id="${u.id}" data-publisher="${!!isPublisherRow}"><i class="fas fa-upload"></i></button>
